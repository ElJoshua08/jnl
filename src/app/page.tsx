...
export default async function Home() {
  ...
  return (
    <div className="h-dvh w-full">
      ...
      <main className="flex flex-col items-center justify-center h-full w-full gap-y-12 relative px-6">
        <div className="absolute lg:block hidden w-[600px] h-[250px] bottom-24 right-24 border-pink-200 dark:border-pink-800 border-b border-r" />

        <div className="absolute lg:block hidden w-[600px] h-[250px] bottom-24 left-24 border-pink-200 dark:border-pink-800 border-b border-l" />
